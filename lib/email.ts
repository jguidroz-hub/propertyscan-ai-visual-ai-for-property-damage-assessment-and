...
const FROM = process.env.EMAIL_FROM || 'PropertyScan AI - Visual AI for property damage assessment and maintenance <noreply@example.com>';
const APP_NAME = 'PropertyScan AI - Visual AI for property damage assessment and maintenance';
