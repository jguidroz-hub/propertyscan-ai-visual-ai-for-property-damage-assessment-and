  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="PropertyScan AI - Visual AI for property damage assessment and maintenance-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
