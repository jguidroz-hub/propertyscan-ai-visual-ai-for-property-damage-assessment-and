  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">PropertyScan AI - Visual AI for property damage assessment and maintenance</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Provides property managers and insurance companies with an AI tool to quickly analyze photos of property damage (e.g., leaks, cracks), recommend maintenance, or assist with preliminary claims assessment, saving time and costs.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust PropertyScan AI - Visual AI for property damage assessment and maintenance.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} PropertyScan AI - Visual AI for property damage assessment and maintenance. All rights reserved.</p>
